...
exports.checkIsNotLocalFile = exports.checkCookiesAuthorized = exports.commonInit = exports.BuildMode = exports.defineGlobal = exports.makePublicApi = void 0;
...
function commonInit(initConfiguration, buildEnv) {
    ...
    var configuration = configuration_1.buildConfiguration(initConfiguration, buildEnv);
...
function checkCookiesAuthorized(options) {
    if (!cookie_1.areCookiesAuthorized(options)) {
        display_1.display.warn('Cookies are not authorized, we will not send any data.');
        return false;
    }
    return true;
}
...
function checkIsNotLocalFile() {
    if (isLocalFile()) {
        display_1.display.error('Execution is not allowed in the current context.');
        return false;
    }
    return true;
}
