...
describe('trace', () => {
    describe('signalToNumber', () => {
        test('should map null to undefined', () => {
            const command = new trace_1.TraceCommand();
    ...
    describe('getCIEnvVars', () => {
        test('should throw if no CI is detected', () => {
            process.env = {};
            const command = new trace_1.TraceCommand();
            expect(command['getCIEnvVars'].bind(command)).toThrow(/Cannot detect any supported CI Provider\. This command only works if run as part of your CI\..*/);
        });
