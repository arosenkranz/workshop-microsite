...
describe('utils', () => {
    ...
    describe('waitForResults', () => {
        ...
        test('should poll result ids', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            expect(yield utils.waitForResults(api, [triggerResult], 120000, [triggerConfig], undefined, false)).toEqual(expectedResults);
        }));
        test('results should be timed-out if global pollingTimeout is exceeded', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            expect(yield utils.waitForResults(api, [triggerResult], 0, [], undefined, false)).toEqual(expectedResults);
        }));
        test('results should be timeout-ed if test pollingTimeout is exceeded', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            expect(yield utils.waitForResults(api, [triggerResult], 120000, [testTriggerConfig], undefined, false)).toEqual(expectedResults);
        }));
        test('correct number of pass and timeout results', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            expect(yield utils.waitForResults(api, [triggerResultPass, triggerResultTimeOut], 2000, [], undefined, false)).toEqual(expectedResults);
        }));
        test('tunnel failure', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            expect(yield utils.waitForResults(api, [triggerResult], 2000, [], mockTunnel, true)).toEqual(expectedResults);
            expect(yield utils.waitForResults(api, [triggerResult], 2000, [], mockTunnel, false)).toEqual(expectedResults);
        }));
        test('pollResults throws', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            expect(yield utils.waitForResults(api, [triggerResult], 2000, [], mockTunnel, false)).toEqual(expectedResults);
            yield expect(utils.waitForResults(api, [triggerResult], 2000, [], mockTunnel, true)).rejects.toThrow();
        }));
    });
