...
const globalTestMock = fixtures_1.getApiTest('123');
const globalStepMock = fixtures_1.getStep();
const globalResultMock = fixtures_1.getBrowserPollResult();
describe('Junit reporter', () => {
    ...
    describe('testEnd', () => {
        ...
        it('should report errors', () => {
            ...
            const apiResult = Object.assign(Object.assign({}, fixtures_1.getApiPollResult()), { result: Object.assign(Object.assign({}, fixtures_1.getMultiStepsResult()), { steps: [
