...
class WebSocket extends events_1.EventEmitter {
            ...
            if (this.websocket) {
                ...
                if (this.websocket.readyState === ws_1.default.OPEN) {
                    if (gracefullyClose) {
                        ...
                        yield events_1.once(this.websocket, 'close');
                    }
    ...
    duplex() {
        ...
        return ws_1.createWebSocketStream(this.websocket, {
    ...
    establishWebsocketConnection(resolve, reject) {
        if (!this.websocket) {
            const options = {};
            const proxyAgent = utils_1.getProxyAgent(this.proxyOpts);
            if (proxyAgent) {
